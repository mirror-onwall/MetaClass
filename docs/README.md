...
- `design-review.md`：对具体设计的工程评审、MVP 收敛与实现顺序。
...
- `api.md`：仅记录 OpenAPI 无法表达的约定，不手抄接口清单。
- `adr/`：一个文件记录一个已落地且难以逆转的架构决策。

设计原稿描述“想做什么”，此目录记录“代码最终如何做”和取舍原因；两者冲突时，以已验证的实现和 ADR 为准。
